...
#            add "Alt_Screen_Mask"
            ...
            frame:
                ...
                has vbox
                hbox:
                    imagebutton idle "gui/icons/lust.png" hover "gui/icons/lust.png" action NullAction() hovered tt.Action("Lust: [Partner.Lust]")
                    ...
                    imagebutton idle "gui/icons/love.png" hover "gui/icons/love.png" action NullAction() hovered tt.Action("Love: [Partner.Love]")
                    ...
                    imagebutton idle "gui/icons/obedience.png" hover "gui/icons/obedience.png" action NullAction() hovered tt.Action("Obedience: [Partner.Obed]") #action NullAction("none")?
                    ...
                    imagebutton idle "gui/icons/exhibition.png" hover "gui/icons/exhibition.png" action NullAction() hovered tt.Action("Inhibitions: [Partner.Inbt]")
