...
init -1 python hide:
    ...
    config.window_title = u"Rogue-Like-Expanded"

    # These control the name and version of the game, that are reported
    # with tracebacks and other debugging logs.
    config.name = "Rogue-Like-Expanded"
    config.version = "1.00.1"
    ...
    theme.tv(
        ...
        mm_root = "gui/titleimage.jpg",

        ## The background of the game menu. This can be a color
        ## beginning with '#', or an image filename. The latter
        ## should take up the full height and width of the screen.
        gm_root = "gui/menuimage.jpg",
    ...
    style.window.background = Frame("gui/chatbox.png", 12, 12)
    ...
    style.say_who_window.background = Frame("gui/Nametag.png", 20,20) #namebox.png
...
# I tried this block below, did not work:
    ...
    style.say_balloon.background = Frame("gui/Wordballoon.png", 50, 50)
    ...
    style.textbox.background = Frame("gui/chatbox.png", 12, 12)
...
python early:
    config.save_directory = "Rogue-Like-Expanded"
...
init python:
    ...
    build.directory_name = "Rogue-Like-Expanded"

    ## The name that's uses for executables - the program that users will run
    ## to start the game. For example, if this is 'mygame', then on Windows,
    ## users can click 'mygame.exe' to start the game.
    build.executable_name = "Rogue-Like-Expanded"
